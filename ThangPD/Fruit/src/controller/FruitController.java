...
public class FruitController {
    ...
    public void createFruit() {
        while (true) {
            ...
            while (true) {
                ...
                view.showMessage(Message.DUPLICATE_ID, true);
            }
    ...
    public void updateFruit() {
        ...
        if (listFruit.isEmpty()) {
            view.showMessage(Message.EMPTY, true);
            return;
        }

        while (true) {
            displayFruitList();
            String id = Input.inputString("Nhập Fruit ID cần update: ");
    ...
    public void viewOrders() {
        if (service.getListOrder().isEmpty()) {
            view.showMessage(Message.ORDER_EMPTY, true);
            return;
        }
    ...
    // Hàm xử lý việc chốt đơn hoặc hủy giỏ hàng
    ...
    public void submitOrder(String customerName,  ArrayList<OrderItem> cart) {
        ...
        view.showMessage(Message.PAYMENT_SUCCESS, false);
    }
}
